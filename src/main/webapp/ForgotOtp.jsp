...
<div class="forget-container">
        <h2>Forgot Otp</h2>
        <h2>Hello ${merchant.getName()}  ${extra}</h2>
            ...
            <div class="form-group">
               ...
               <div class="button-group">
                ...
                <button type="reset" class="btn-cancel">Cancel</button>
                      ...
                      <p>Want a Resend OTP ? <a href="/merchant/resend-forgot-otp/${merchant.getEmail()}"> Resend OTP</a></p>
                      <p>have to Login ? <a href="/MerchantLogin.jsp">Login</a></p>
            </div>
