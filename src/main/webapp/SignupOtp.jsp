...
<body>
	...
	<h2>${pass}</h2>
	<h2>${fail}</h2>
<%-- 	<h2>Hello ${merchant.getName()} Enter OTP ${extra}</h2>
 --%><div class="forget-container">
        
        <h2>Hello ${merchant.getEmail()} Enter OTP ${extra}</h2>
            ...
            <div class="form-group">
               ...
               <div class="button-group">
                ...
                <button type="reset" class="btn-cancel">Cancel</button>
                      ...
                      <p>Want a Resend OTP ? <a href="/merchant/resend-otp/${merchant.getEmail()}"> Resend OTP</a></p>
            </div>
